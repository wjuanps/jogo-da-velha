...
public class JogoDaVelhaGUI extends JFrame {
	...
	public JogoDaVelhaGUI(Jogador jogador1, Jogador jogador2, Maquina maquina) {
		...
		informacoesJogo[2].setBounds(50,210,350,30);
		...
		jogoDaVelha.Jogada(jogador1, jogador2, botao, informacoesJogo, maquina);
		
		if(maquina != null)
			maquina.jogadaMaquina(botao, true);
		
		personalizar = new TelaPersonalizacao(botao, informacoesJogo, this, "Personalização", true);
	...
	public void addNome(Jogador jogador1, Jogador jogador2, Maquina maquina) {
		if(maquina != null) {
			this.maquina.setNome(maquina.getNome());
			informacoesJogo[4].setText(maquina.getNome() + "  |   Simbolo   O");
		}
		if(jogador2 != null) {
	...
	private class TratadoerDeItens implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource() == fonte) {
				...
				jogoDaVelha.zerarValores(informacoesJogo, jogador1, jogador2, maquina);
